...
class TestIntegration(unittest.TestCase):
    ...
    def test_home_route(self, mock_get_weather_forecast):
        # Mock the WeatherAppService to return a fake forecast
        mock_get_weather_forecast.return_value = WeatherForecast({
            'date': ['2023-10-01'],
    ...
    def test_home_route_failure(self, mock_get_weather_forecast):
        # Mock the WeatherAppService to return None (simulate failure)
